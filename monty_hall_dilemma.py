...
class MontyHall:
    ...
    def game_loop_with_player(self):
        self.reset_game()
        self.player_door_selection = int(input("Choose a door 1-3?\n >>>"))
        ...
        print("Do you want to swap or stay?")
        self.player_swap_input = int(input("(1) to swap or (2) to stay.\n>>>"))
    ...
    """ Chooses whether to stay with the door selection(1),
        swap(2), or randomly choose(3)"""
